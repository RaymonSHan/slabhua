...
*** DONE start private chain
clear ~/.ethereum ~/.web ~/.ethash
.../alethzero
menu/config/use private chain
  start listening 8545
.../ethminer                                           # MUST 4G memory or higher
  get DAG
*** install nodejs
